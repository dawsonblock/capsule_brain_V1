"""Generate benchmark_manifest.json for AutoLearn v0.2.

Records the benchmark configuration: task count, archetype count, split
strategy, feature schema version, and SHA-256 provenance.
"""
...
def main() -> None:
    ...
    manifest = {
        "benchmark_version": "autolearn_v0.2",
