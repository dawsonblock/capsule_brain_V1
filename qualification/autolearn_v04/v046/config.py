"""Configuration for v0.4.6 qualification analysis.

This module reuses the same required-evidence-file list as v0.4.5 but
adjusts placeholder markers so that "synthetic" is NOT treated as a
placeholder — it is expected in fixture evidence.
"""
...
# Required evidence files (same as v0.4.5)
...
# NOTE: "synthetic" is intentionally NOT included here — it is expected in
# fixture evidence and must not trigger a placeholder failure.
PLACEHOLDER_MARKERS = (
    "placeholder",
...
# Gate A0 sub-gate count for v0.4.6
GATE_A0_N_SUB_GATES = 24


@dataclass(frozen=True, slots=True)
class AnalysisConfig:
    """Configuration for a single v0.4.6 analysis run."""
